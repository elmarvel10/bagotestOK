  ...
  return (
    <div className="relative w-full">
      ...
      >
        ...
        {/* Indicador visual de que es clickeable - solo visible en desktop */}
        <div className="absolute inset-0 bg-black bg-opacity-20 opacity-0 hover:opacity-100 transition-opacity flex items-center justify-center">
          <span className="hidden md:block text-white text-lg font-medium bg-black bg-opacity-50 px-4 py-2 rounded-full">
            Siguiente imagen
          </span>
        </div>
      </div>
